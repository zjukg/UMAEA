...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--data_path", default="umvm", type=str, help="Experiment path")

        # --------- EA -----------
        parser.add_argument("--data_choice", default="DBP15K", type=str, choices=["DBP15K", "DWY", "FBYG15K", "FBDB15K", "OEA_EN_FR_15K_V1", "OEA_EN_FR_15K_V2", "OEA_D_W_15K_V2",
        ...
        parser.add_argument("--model_name", default="EVA", type=str, choices=["EVA", "MCLEA", "MSNEA", "UMAEA"], help="model name")
        ...
        # --------- EVA -----------
        parser.add_argument("--data_split", default="fr_en", type=str, help="Experiment split", choices=["dbp_wd_15k_V2", "dbp_wd_15k_V1", "zh_en", "ja_en", "fr_en", "norm", "dense"])
        ...
        # --------- UMAEA -----------
        parser.add_argument("--hidden_size", type=int, default=100, help="the hidden size of UMAEA")
        parser.add_argument("--intermediate_size", type=int, default=400, help="the hidden size of UMAEA")
        parser.add_argument("--num_attention_heads", type=int, default=5, help="the number of attention_heads of UMAEA")
        parser.add_argument("--num_hidden_layers", type=int, default=2, help="the number of hidden_layers of UMAEA")
        ...
        parser.add_argument("--stage_epoch", type=str, default="250,50,150")
    ...
    def update_train_configs(self):
        ...
        if self.cfg.model_name not in ["UMAEA", "MSNEA", "EVA", "MCLEA"]:
